...
<body>
  <div class="container p-t-150 p-b-80" id="user_join">
    <div class="col-sm-5 bor10 p-lr-40 p-t-30 p-b-25 p-lr-15-sm">
      <form ref="form" method="post" action="../user/join_ok.do">
      
        <div class="text-left"> 
          <div>
            <div>아이디</div>
            <input class=bor10 type="text" name="id" id="id" v-model="id">
            <input type="button" id="id-check-btn" v-on:click="id-check-btn" value="중복 확인">
          </div>
        
          <div>
            <div>이름</div>
            <input class=bor10 type="text" name="name" id="name" v-model="name">
          </div>
          
          <div>
            <div>비밀번호 입력</div>
            <input class=bor10 type="password" name="password" id="password" v-model="password">
          </div>
          ...
          <div>
            <div>성별</div>
            	<label class="radio-inline"><input class="form-check-input" type="radio" value="남자" name=gender checked="checked" v-model="gender"> 남자</label>
                <label class="radio-inline"><input class="form-check-input"  type="radio" value="여자" name=gender v-model="gender"> 여자</label>
          </div>
        
          <div>
            <div>이메일</div>
            <input class=bor10 type="text" name="email" id="email" v-model="email">
            <input type="button" id="email-check-btn" v-on:click="email-check-btn" value="중복 확인">
          </div>
        
          <div>
            <div>전화번호</div>
            <input class=bor10 type="text" name="phone" id="phone" v-model="phone">
          </div>
        
          <div>
            <div>우편번호</div>
            <input type="text" name="post" id="post" v-model="post">
            ...
            <div>상세주소</div>
            <input class=bor10 type="text" name="address2" id="address2" v-model="address2">
          </div>
          ...
          <div>
            ...
            <div>비밀번호 찾기 답변</div>
            <input class=bor10 type="text" name=answer id=answer v-model="answer">
          </div>
        </div>
