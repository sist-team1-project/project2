      ...
      <form method=post action="../support/ask_insert_ok.do">
        <table class="table">
          <tr>
            ...
            <td width=80%><select class="form-select" name=a_type>
          ...
          <tr>
            ...
            <td width=80%><input name="u_id" value="${sessionScope.id }" readonly="readonly"></td>
          </tr>
          <tr>
            <th width=20% class="text-right">제목</th>
            <td width=80%><input type=text name=a_title size=55 class="input-sm"></td>
          </tr>
          <tr>
        ...
        <div class="text-right" colspan="2" class="text-center">
          <input type=submit value="글쓰기" class="btn btn-sm" style="background-color: #eeeee6"> <input type=button value="취소" class="btn btn-sm" style="background-color: #dbd0be" onclick="javasecript:history.back()">
        </div>
      </form>
    </div>
  </div>
