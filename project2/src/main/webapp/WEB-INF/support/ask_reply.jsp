  ...
  <div class="container bg0">
    ...
    <div class="row">
      <form method=post action="../support/ask_reply_ok.do">
        <table class="table">
          <tr>
            <th width=20% class="text-right">유형</th>
            <td width=80%><input type=text name=a_type size=15 value="답변"
            class="input-sm"><input type="hidden" name=pno value="${no }"></td>
          </tr>
          <tr>
            <th width=20% class="text-right">이름</th>
            <td width=80%><input type=text name=u_id size=15 value="${sessionScope.id }"
            class="input-sm"></td>
          </tr>
          <tr>
        ...
        <div colspan="2" class="text-right">
          ...
          <input type=button value="취소" class="btn btn-sm" style="background-color: #dbd0be" onclick="javasecript:history.back()">
        </div>
      </form>
    </div>
  </div>
